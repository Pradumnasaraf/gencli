...
func setModelConfig() {
	...
	options := []string{"Gemini 3 Pro", "Gemini 3 Flash", "Gemini 3.5 Flash", "Gemini 2.5 Pro", "Gemini 2.5 Flash", "Gemini 2.5 Flash-Lite", "Gemini 2.0 Flash", "Gemini 2.0 Flash-Lite"}
